...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/seashipnet.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/sar-ship.yaml', help='dataset.yaml path')
...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.resume and not check_comet_resume(opt) and not opt.evolve:
        ...
        opt.name = opt.data.split('\\')[-1].split('.')[0] + '_' + opt.cfg.split('\\')[-1].split('.')[0]
